...
import userinterface.ApprovalRole.ApprovalWorkAreaJPanel;
...
public class ApprovalRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account,Network network, Organization organization, Enterprise enterprise, EcoSystem business) {
        return new ApprovalWorkAreaJPanel(userProcessContainer, account, (ApprovalOrganization)organization, enterprise,business, network);
    }
